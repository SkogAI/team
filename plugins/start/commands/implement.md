...
Check if $ARGUMENTS contains a specification ID in the format "010" or "010-feature-name". Run `~/.claude/plugins/marketplaces/skogai-team/plugins/start/scripts/spec.py [ID] --read` to check for existing specification.
